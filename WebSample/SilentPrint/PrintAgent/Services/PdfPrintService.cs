...
namespace PrintAgent.Services
{
	...
	static class PdfPageExtension
    {
            ...
            bool maintainAspectRatio = true, bool allowUpscaling = false, bool center = true)
        {
            ...
            {
                var viewState = new GrapeCity.Documents.Pdf.Layers.ViewState(page.Doc);
				viewState.Mode = GrapeCity.Documents.Pdf.Layers.ViewState.ViewMode.Print;

				page.SaveAsBmp(memoryStream, viewState, new SaveAsImageOptions{ Resolution = 300 });
