Namespace CodeReports
	...
	Partial Public Class NwindLabelsFiltered
		...
		Private Sub InitializeComponent()
			...
			Me.Country = New SectionReportModel.Parameter()
			Me.Parameters.Add(Me.Country)
			...
			'Country
			'
			Me.Country.DefaultValue = "UK"
			Me.Country.Key = "Country"
			Me.Country.Prompt = "Country:"
			Me.Country.PromptUser = True
			Me.Country.QueryCreated = False
			Me.Country.Tag = Nothing
			Me.Country.Type = GrapeCity.ActiveReports.SectionReportModel.Parameter.DataType.String
			'
			'NwindLabelsFiltered
			'
		...
		Public WithEvents Country As GrapeCity.ActiveReports.SectionReportModel.Parameter
	End Class
End Namespace