# Webデザイナ Angular8 サンプル

このサンプルはJavaScriptフレームワークのAngular8と、ASP.NET Coreを利用してActiveReports.NETのWebデザイナを使用するサンプルです。
...
5. コマンド プロンプトを開き、..\ClientApp フォルダーに移動します。
6. `npm install` コマンドを実行します。
