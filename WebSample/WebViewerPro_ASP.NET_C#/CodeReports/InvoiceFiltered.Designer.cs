namespace GrapeCity.ActiveReports.Samples.Web.CodeReports
{
	...
	partial class InvoiceFiltered
	{
		...
		private void InitializeComponent()
		{
			...
			this.StartingDate = new SectionReportModel.Parameter();
			this.EndingDate = new SectionReportModel.Parameter();
			this.Parameters.Add(this.StartingDate);
			this.Parameters.Add(this.EndingDate);
